...
<body>
    <h1>Tabela das Unidades Federativas do Brasil</h1>
    <table>
        <thead>
            <tr>
                <th>Bandeira</th>
        ...
        <tbody>
            ...
            $UFS = array(
                ...
                'AP' => array(
                    ...
                    'total' => number_format(0.2, 1, ','),
                    'percapita' =>number_format(18079.54, 2, ',', ' '),
                ...
                'MT' => array(
                    ...
                    'percapita' =>number_format(32894.96, 2, ',', ' '),
                ...
                'MG' => array(
                    ...
                    'percapita' =>number_format(24884.94, 2, ',', ' '),
                    'IDH' => number_format(0.731, 3, ','),
                    'alfabetizacao' => number_format(93.8, 1, ',') . '%',
                    'mortalidadeinfantil' => number_format(10.9, 1, ',') . '&#8240;',
                    'expectativadevida' => number_format(77.2, 1, ',') . 'anos'      
                ),
                'PA' => array(
                ...
                'PE' => array(
                    ...
                    'percapita' =>number_format(16795.34, 2, ',', ' '),
                ...
                'PI' => array(
                    ...
                    'percapita' =>number_format(12218.51, 2, ',',' '),
                    'IDH' => number_format(0.646, 3, ','),
                    'alfabetizacao' => number_format(82.8, 1, ',') . '%',
                    'mortalidadeinfantil' => number_format(19.1, 1, ',') . '&#8240;',
                    'expectativadevida' => number_format(71.1, 1, ',') . 'anos'
                ),
                'RJ' => array(
                    ...
                    'total' => number_format(11, 0,' '),
                    'percapita' => number_format(39826.95, 2, ',',' '),
                    'IDH' => number_format(0.761, 3, ','),
                    'alfabetizacao' => number_format(97.3, 1,',') . '%',
                    'mortalidadeinfantil' => number_format(11.5, 1,',') .  '&#8240;',
                    'expectativadevida' => number_format(76.2, 1, ',') . 'anos'
                ),
                'RN' => array(
                    ...
                    'total' => number_format(1, 0, ' '),
                    'percapita' =>number_format(16631.86, 2, ',',' '),
                    'IDH' => number_format(0.684, 3, ','),
                    'alfabetizacao' =>number_format(85.3, 1, ',') .'%',
                    'mortalidadeinfantil' => number_format(14.7, 1, ',') .  '&#8240;',
                    'expectativadevida' => number_format(75.7, 1, ',') . 'anos'
                ),
                'RS' => array(
                ...
                'SP' => array(
                    ...
                    'percapita' => number_format(43694.68, 2, ',', ' '),
                ...
                'SE' => array(
                    ...
                    'total' => number_format(0.6, 1, ','),
                    'percapita' => number_format(17189.28, 2, ',', ' '),
                    'IDH' => number_format(0.665, 3, ','),
                    'alfabetizacao' => number_format(85.3, 1, ',') . '%',
                    'mortalidadeinfantil' => number_format(16.2, 1, ',') . '&#8240;',
                    'expectativadevida' => number_format(72.7, 1, ',') . 'anos'
                ),
                'TO' => array(
